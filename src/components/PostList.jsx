      ...
      >
        <div className="modern-card p-6">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="text-xl font-bold text-gray-800">Discover Posts</h2>
          </div>
          ...
          <form onSubmit={handleSearch} className="space-y-4">
            <div className="relative group">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-3.5 bg-gray-50 border-2 border-gray-200 rounded-xl focus:ring-4 focus:ring-purple-500/20 focus:border-purple-500 transition-all outline-none text-gray-800 placeholder:text-gray-400"
              />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2.5 bg-gray-50 border-2 border-gray-200 rounded-lg focus:ring-4 focus:ring-purple-500/20 focus:border-purple-500 transition-all outline-none"
                />
              </div>
              <div className="relative">
            ...
            {posts.map((post, index) => (
              ...
              >
                <Link to={`/posts/${post.id}`}>
                  <div className={cn(
                    "modern-card p-6 h-full cursor-pointer",
                      ...
                      <div className="flex items-center gap-2 mb-4 flex-wrap">
                        {post.tags.split(',').slice(0, 3).map((tag, i) => (
                          <motion.span
                            ...
                            className="px-3 py-1 bg-gradient-to-r from-purple-100 to-pink-100 text-purple-700 rounded-full text-xs font-semibold hover:from-purple-200 hover:to-pink-200 transition-all"
                          >
                            #{tag.trim()}
                          </motion.span>
                        ))}
                    ...
                    <div className="flex items-center gap-6 pt-4 border-t border-gray-100">
                      ...
                      <div className="flex items-center gap-2 text-gray-600 hover:text-blue-500 transition-colors">
                        <MessageCircle size={18} />
                        <span className="text-sm font-medium">Comment</span>
                      </div>
                      <div className="ml-auto">
                        <span className="text-sm text-purple-600 font-semibold group-hover:translate-x-1 inline-block transition-transform">
                          Read more →
                        </span>
                      </div>
                    </div>
